...
iptables -t mangle -A PREROUTING -s 192.168.68.0/24 -j MARK --set-xmark 0x10000/0xff0000
iptables -t nat -A PREROUTING -s 192.168.68.0/24 -j MARK --set-xmark 0x10000/0xff0000
